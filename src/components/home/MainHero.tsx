...
export function MainHero() {
	return (
		<section className="relative w-full pt-20 pb-16 md:pt-32 md:pb-24 overflow-hidden z-10 transition-colors">
			<div className="container mx-auto px-4 lg:px-8 relative">
				<div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-12 items-center mb-16 md:mb-24">
					...
					<div className="text-left space-y-8 max-w-xl relative z-20">
						...
						{/* Subheadline */}
						<h2 className="text-2xl md:text-3xl font-semibold text-foreground leading-snug mb-6 transition-colors">
						...
						{/* Paragraph */}
						<p className="text-base md:text-lg text-muted-foreground font-normal max-w-2xl leading-relaxed mb-8 transition-colors">
							Tu formación necesita peso. Consíguelo respaldándote con la <strong className="text-foreground transition-colors">élite nacional (CIP, CAP, CEL)</strong> y los <strong className="text-foreground transition-colors">líderes globales (Autodesk, RIB Presto)</strong>.
						</p>
					...
					<div className="relative w-full min-h-[500px] lg:min-h-[650px] flex items-end justify-center z-10 mt-16 lg:mt-0">
						...
						<div className="absolute bottom-[5%] lg:bottom-[10%] w-[95%] sm:w-[85%] max-w-[460px] h-[75%] z-10 flex items-end justify-center">
							...
							<div 
								className="absolute inset-0 w-full h-full bg-gradient-to-br from-primary/80 via-primary/60 to-transparent backdrop-blur-[2px] border border-primary/20 rounded-xl z-0"
								style={{
						...
						<div className="absolute top-[10%] md:top-[0%] left-[-5%] sm:left-[5%] md:left-[-15%] lg:left-[-5%] z-30 bg-card/90 backdrop-blur-xl border border-gold/30 shadow-xl rounded-2xl p-4 flex items-center gap-4 hover:scale-105 transition-all animate-in fade-in slide-in-from-bottom-5 duration-700">
							...
							<div>
								<p className="text-foreground font-bold text-sm transition-colors">
									Certificación
								</p>
						...
						{/* Center Right Widget: Live Classes */}
						<div className="absolute top-[30%] right-[-5%] sm:right-[0%] md:right-[-10%] lg:right-[-8%] z-30 bg-card/90 backdrop-blur-xl border border-border shadow-2xl rounded-2xl p-5 min-w-[240px] hover:scale-105 transition-all animate-in fade-in slide-in-from-bottom-5 duration-700 delay-150">
							<div className="flex items-center gap-4 mb-4">
								...
								<div>
									<h4 className="text-foreground font-bold text-lg leading-none transition-colors">
										Clases en Vivo
									</h4>
						...
						<div className="absolute bottom-[5%] md:bottom-[15%] left-[-5%] sm:left-[5%] md:left-[-10%] lg:left-[0%] z-30 bg-card/90 backdrop-blur-xl border border-border shadow-2xl rounded-2xl p-4 flex items-center gap-4 hover:scale-105 transition-all animate-in fade-in slide-in-from-bottom-5 duration-700 delay-300">
							<div className="w-10 h-10 lg:w-12 h-12 bg-primary/10 dark:bg-primary/15 rounded-xl flex items-center justify-center border border-primary/20 dark:border-primary/30">
								<Briefcase className="w-5 h-5 lg:w-6 lg:h-6 text-primary" />
							</div>
							<div>
								<h4 className="text-foreground font-bold text-base lg:text-lg leading-none transition-colors">
									+5 Años
								</h4>
								<p className="text-muted-foreground text-[10px] lg:text-xs mt-1 transition-colors">
									De Experiencia
								</p>
							</div>
						</div>
				...
				{/* Clients Banner right at the bottom of the Hero Section */}
